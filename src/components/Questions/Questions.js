      ...
      <div className="accordion accordion-flush mb-5" id="accordionFlushExample">
        <div className="accordion-item">
          <h2 className="accordion-header" id="flush-headingOne">
            <button
              className="accordion-button collapsed bg-info bg-gradient bg-opacity-50"
              type="button"
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              The useEffect Hook allows us to perform side effects in the components. Some examples of side effects are: fetching data, directly updating the DOM, and timers. useEffect accepts two arguments. The second argument is optional.
            </div>
          </div>
        </div>
      </div>
